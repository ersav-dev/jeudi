...
export const REPERES: PointRdv[] = [
  ...
  { nom: 'république', img: '/monuments/republique.png', etq: '/monuments/republique-etq.png', rdv: 'au pied de la statue', lat: 48.86754, lng: 2.36396 },
  ...
  { nom: 'place vendôme', img: '/monuments/colonne-vendome.png', etq: '/monuments/colonne-vendome-etq.png', rdv: 'au pied de la colonne', lat: 48.86746, lng: 2.32943 },
  { nom: 'hôtel de ville', img: '/monuments/hotel-de-ville.png', etq: '/monuments/hotel-de-ville-etq.png', rdv: 'sur le parvis', lat: 48.85643, lng: 2.35253 },
  ...
  { nom: 'colonnes de buren', img: '/monuments/palais-royal.png', etq: '/monuments/palais-royal-etq.png', rdv: 'au milieu des colonnes', lat: 48.8636, lng: 2.33707 },
  ...
  { nom: 'bir-hakeim', img: '/monuments/station-bir-hakeim.png', etq: '/monuments/station-bir-hakeim-etq.png', rdv: 'sous les arcades', lat: 48.85573, lng: 2.28755 },
  { nom: 'vert-galant', rdv: "à la pointe de l'île", lat: 48.85741, lng: 2.34033 },
  // ── les jardins, au repère précis ──
  { nom: 'fontaine médicis', img: '/monuments/jardin-du-luxembourg.png', etq: '/monuments/jardin-du-luxembourg-etq.png', rdv: 'devant le bassin', lat: 48.84806, lng: 2.33929 },
