...
export type PointRdv = {
  ...
  img?: string
  /** son cartouche séparé ; absent = déjà incorporé dans la vignette */
  etq?: string
}
...
export const REPERES: PointRdv[] = [
  ...
  { nom: 'bastille', img: '/monuments/bastille.webp', rdv: 'au pied de la colonne', lat: 48.85317, lng: 2.36914 },
  ...
  { nom: 'fontaine saint-michel', img: '/monuments/fontaine-saint-michel.webp', rdv: 'devant la fontaine', lat: 48.85329, lng: 2.34364 },
  { nom: 'saint-sulpice', img: '/monuments/saint-sulpice.webp', rdv: 'à la fontaine', lat: 48.85087, lng: 2.33328 },
  { nom: 'pyramide du louvre', img: '/monuments/pyramide-du-louvre.webp', rdv: 'devant la pyramide', lat: 48.86099, lng: 2.33584 },
  ...
  { nom: 'trocadéro', img: '/monuments/trocadero.webp', rdv: 'sur le parvis, face à la tour', lat: 48.86208, lng: 2.28854 },
  ...
  { nom: 'pont alexandre iii', img: '/monuments/pont-alexandre-iii.webp', rdv: 'au pied des pylônes dorés', lat: 48.86347, lng: 2.31352 },
