                  ...
                  >
                    <span className="membre-nom">
                      ...
                      {estPro && (
                        ...
                        >
                          {/* designALT : le sceau de cire — jamais d'étoile (DA) */}
                          <span className="sceau-mini" aria-hidden="true" /> super pote
                        </span>
                      )}
                    </span>
                    <button
...
function Fiche({
  ...
  // designALT : le reflet spéculaire glisse sur le tirage (souris / gyroscope)
  useReflet(true)
    ...
    <div className="fiche">
      ...
      >
        <div className="carte-photo">
          ...
          {/* designALT : le reflet spéculaire du polaroïd (lit --gx/--gy) */}
